...
import { Activity, TestTube2, AlertTriangle, CheckCircle2, TrendingUp, TrendingDown } from "lucide-react";
        ...
        {stats.map((stat) => {
          ...
          return (
            ...
            >
              ...
              <div className={`absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${stat.trendUp ? 'from-emerald-400 to-cyan-400' : 'from-red-400 to-amber-400'}`} />
              ...
              <CardContent className="p-5">
                ...
                <div className="mt-3 flex items-center text-xs">
                  <span className={`flex items-center font-medium ${stat.trendUp ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400"}`}>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="lg:col-span-4 shadow-sm border-slate-200/60 dark:border-slate-800/60 bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl">
          <CardHeader className="p-5 pb-0">
            <CardTitle className="text-sm font-semibold text-slate-800 dark:text-slate-200">Recent Samples</CardTitle>
          </CardHeader>
          <CardContent className="p-5">
        ...
        <Card className="lg:col-span-3 shadow-sm border-slate-200/60 dark:border-slate-800/60 bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl">
          <CardHeader className="p-5 pb-0">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-semibold text-slate-800 dark:text-slate-200">Action Required</CardTitle>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5 leading-snug">
                      pH value <span className="font-semibold text-slate-700 dark:text-slate-300">8.4</span> exceeds upper specification limit (8.0). Immediate supervisor review requested.
                    </p>
