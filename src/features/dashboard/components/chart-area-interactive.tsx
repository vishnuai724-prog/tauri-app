...
import { useDashboardSearchParams } from "@/shared/hooks/search-params";
...
export function ChartAreaInteractive() {
  ...
  return (
    <Card className="@container/card bg-linear-to-br from-blue-500/5 via-background to-background border-border/50 shadow-sm">
      <CardHeader>
