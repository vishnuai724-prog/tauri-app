...
} from "@/shared/hooks/search-params";
import { useIsMobile } from "@/shared/hooks/use-mobile";
import { schema } from "../schemas/dashboard.schema";
...
export function DataTable({
  ...
  const TableContent = ({
    ...
    <>
      <div className="overflow-hidden rounded-lg border border-border/50 bg-linear-to-br from-blue-500/5 via-background to-background shadow-sm">
        <DndContext
